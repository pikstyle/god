    ...
    <div className={styles.wrapper} >
      ...
      <div className={styles.page} >
        <Routes>
          ...
          <Route path="/editor-debug" element={textHome ? <Canvas sendAnnonce={sendAnnonce} user={user} editable={true} content={textHome} onSave={saveHomeContent} editable={true}/> : null} />
        </Routes>
      </div>
